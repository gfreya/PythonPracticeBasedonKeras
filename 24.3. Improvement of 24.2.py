...
from keras.layers import Dropout,Activation,Conv2D,MaxPooling2D,GlobalAveragePooling2D
...
def build_model():
    ...
    model.add(Conv2D(192,(5,5),padding='same',kernel_constraint=keras.regularizers.l2(0.0001),kernel_initializer=RandomNormal(stddev=0.01),input_shape=x_train.shape[1:],activation='relu'))
...
if __name__ == '__name__':
    ...
    # callback function, learning rate decay
